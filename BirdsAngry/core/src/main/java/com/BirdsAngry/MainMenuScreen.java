...
//        exitButtonRectangle = new Rectangle(300 , 0, 200, 100);
    ...
    public static void set_current_level_state(Screen current_level_state){
        if (current_level_state instanceof Level1){
            MainMenuScreen.current_level_state = current_level_state;
        }
...
//                    game.setScreen(current_level_state);
                      stage.clear();
                      createloadgame loadlLevel = new createloadgame(game, batch, new Texture("go.png"), new Texture("go1.png"), new Texture("level1background.png"), new Texture("pausebutton.png"), new Texture("catapult.png"), new Stage(), current_level_state);
                      game.setScreen(loadlLevel);
                }
                else if (current_level_state instanceof Level2){
//                    game.setScreen(current_level_state);
                      stage.clear();
                      createloadgame loadlLevel = new createloadgame(game, batch, new Texture("go.png"), new Texture("go1.png"), new Texture("level2background.png"), new Texture("pausebutton.png"), new Texture("catapult.png"),new Stage(), current_level_state);
                      game.setScreen(loadlLevel);
                }
                else if (current_level_state instanceof Level3){
//                    game.setScreen(current_level_state);
                        stage.clear();
                        createloadgame loadlLevel = new createloadgame(game, batch, new Texture("go.png"), new Texture("go1.png"), new Texture("level3background.png"), new Texture("pausebutton.png"), new Texture("catapult.png"),new Stage(), current_level_state);
                        game.setScreen(loadlLevel);
                }
                else {
//                    stage.clear();
