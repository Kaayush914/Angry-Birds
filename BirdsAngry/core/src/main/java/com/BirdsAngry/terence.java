...
public class terence extends Birds implements Serializable {
    ...
    private int height;
    private int velocity;
    private transient Texture terence;
    private transient TextureRegion terenceRegion;
    ...
    public terence(String name, int posx,int posy, int velocity, int width, int height) {
        ...
        this.velocity = velocity;
        terence = new Texture("terence.png");
        terenceRegion = new TextureRegion(terence);
...
//            trajectoryHandler.calculateTrajectory(dragStart, new Vector2(dragStart.x - dragEnd.x, dragStart.y - dragEnd.y));
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(terenceRegion, getX(), getY(),getWidth()/2,getHeight()/2,getWidth(), getHeight(),1,1,getRotation());
