...
//
//    public redbird(String name, int posx,int posy, int velocity, int width, int height) {
...
//        redbirdRegion = new TextureRegion(redbird);
...
//                    newY = 70; // Ensure it stops at ground level
...
//    }
//
//    private void updatedrag(int newX, int newY) {
//        dragStart.set(newX, newY);
//        dragEnd.set(newX, newY);
//    }
//
...
//        batch.draw(redbirdRegion, getX(), getY(),getWidth()/2,getHeight()/2,getWidth(), getHeight(),1,1,getRotation());
//
//    }
//    @Override
...
public class redbird extends Birds implements Serializable {
    private String name;
    private int posx;
    private int posy;
    private int width;
    ...
    private transient TextureRegion redbirdRegion;
