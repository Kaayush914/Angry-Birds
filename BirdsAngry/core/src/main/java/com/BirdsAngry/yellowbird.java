...
public class yellowbird extends Birds implements Serializable{
    private String name;
    private int posx;
    private int posy;
    private int width;
    private int height;
    private int velocity;
    private transient Texture yellowbird;
    private transient TextureRegion yellowbirdRegion;
    ...
    public yellowbird(String name, int posx,int posy, int velocity, int width, int height) {
        ...
        this.velocity = velocity;
        yellowbird = new Texture("yellowbird.png");
        yellowbirdRegion= new TextureRegion(yellowbird);
...
//            trajectoryHandler.calculateTrajectory(dragStart, new Vector2(dragStart.x - dragEnd.x, dragStart.y - dragEnd.y));
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(yellowbirdRegion, getX(), getY(),getWidth()/2,getHeight()/2,getWidth(), getHeight(),1,1,getRotation());
